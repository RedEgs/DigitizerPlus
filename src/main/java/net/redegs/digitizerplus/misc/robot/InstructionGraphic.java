...
public class InstructionGraphic extends Graphic {
    ...
    private ButtonGraphic removeButton = new ButtonGraphic(x, y, texture, 148, 218, 10, 11);
    private ButtonGraphic handleButton = new ButtonGraphic(x, y, texture, 158, 218, 10, 11);
    ...
    public void Draw(GuiGraphics guiGraphics, int mouseX, int mouseY, float deltaT, int guiPositionX, int guiPositionY) {
        ...
        if (this.instruction != null) {
            guiGraphics.drawString(font, String.valueOf(instruction.stackIndex), dx + 3 , dy + 3, 0xFFFFFF);
